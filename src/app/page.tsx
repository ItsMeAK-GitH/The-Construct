      ...
      <main className="flex-1">
        ...
        <section id="features" className="container mx-auto px-4 md:px-6 py-24">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <Card className="bg-card/70 backdrop-blur-lg border-primary/20 transition-all duration-300 hover:border-primary/40 hover:shadow-2xl hover:shadow-accent/20 hover:scale-105 hover:backdrop-blur-xl">
                    <CardHeader>
